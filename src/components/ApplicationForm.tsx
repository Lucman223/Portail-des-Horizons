    ...
    if (success) {
        return (
            <div className="text-center py-20 animate-fade-in-up">
                ...
                <p className="text-lg text-gray-600 mb-8">{t('success_msg')}</p>

                <a
                    href="https://wa.me/22391437485?text=Bonjour,%20je%20viens%20d'envoyer%20ma%20candidature%20sur%20la%20plateforme."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-[#25D366] text-white font-bold text-lg rounded-full hover:bg-[#20b858] transition-transform hover:scale-105 shadow-lg"
                >
